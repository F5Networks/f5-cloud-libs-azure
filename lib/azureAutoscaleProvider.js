    ...
    .then(function(data) {
        ...
        msRestAzure.loginWithServicePrincipalSecret(
            ...
            function(err, credentials) {
                ...
                this.storageClient.createContainerIfNotExists(BACKUP_CONTAINER, undefined, function(err) {
                    if (err) {
 ...
 */
AzureAutoscaleProvider.prototype.masterElected = function(masterId) {
    if (masterId === this.instanceId) {
