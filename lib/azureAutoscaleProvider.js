 ...
 * @returns {Promise} A promise which will be resolved when processing is complete.
 */
AzureAutoscaleProvider.prototype.tagMasterInstance = function tagMasterInstance(masterIid, instances) {
 ...
 */
AzureAutoscaleProvider.prototype.storeUcs = function storeUcs(file, maxCopies, prefix) {
