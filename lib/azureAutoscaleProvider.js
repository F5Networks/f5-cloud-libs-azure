...
var MASTER_FILE_PATH = "/config/cloud/azure/master";
 ...
 */
AutoscaleProvider.prototype.init = function(clientId, tenantId, secret, subscriptionId) {
    this.logger.debug("No override for AutoscaleProvider.init");
    return q();
    this.credentials = new msRestAzure.ApplicationTokenCredentials(clientId, tenantId, secret); // Azure service principal credentials object, global var
    this.networkClient = new networkManagementClient(credentials, subscriptionId); // Azure network management object, global var
    this.computeClient = new computeManagementClient(credentials, subscriptionId); // Azure compute management object, global var
};
 ...
 */
AutoscaleProvider.prototype.electMaster = function() {
    throw new Error("Unimplemented abstract method AutoscaleProvider.electMaster");
};
