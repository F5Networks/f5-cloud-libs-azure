 ...
 * @param {String}  providerOptions.clientId        - Azure client ID
 * @param {String}  providerOptions.tenantId        - Azure tenant ID
 * @param {String}  providerOptions.secret          - Azure secret
 * @param {String}  providerOptions.subscriptionId  - Azure subscription ID
 *
