        ...
        .then(function(data) {
            msRestAzure.loginWithServicePrincipalSecret(
                ...
                function(err, credentials) {
                    ...
                    this.computeClient = new ComputeManagementClient(credentials, data.subscriptionId);
                    this.networkClient = new NetworkManagementClient(credentials, data.subscriptionId);
                    deferred.resolve();
                });
        })
        .catch(function(err) {
